...
- `PROXY_USERNAME`: usuario del proveedor, si el proxy requiere autenticación.
- `PROXY_PASSWORD`: contraseña del proxy, si requiere autenticación.

Para un proxy gratuito sin autenticación basta con `PROXY_SERVER`. El recolector
utiliza el proxy solamente cuando ese secreto está definido.
